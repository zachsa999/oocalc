...
<div class="para">
	<p>The Carrier:<input type="text" class="oo" />, and</p>
</div>
<div class="para">
	<p>
		Owner Operator "OO"<input type="text" class="" />(Hereinafter referred to as "The contractor")
	</p>
</div>
...
<div>
	<h3 class="para">The Carrier and Contractor desire to enter a contract and agree as follows:</h3>
	<p class="para">
		The Carrier is in the business of transporting goods for compensation by highway, whereas the
	...
	<p class="para">
		The Contractor agrees to make themselves/employees/agents available for any requirement
	...
	<p class="para">
		Transportation of cargo other than as tendered to the Contractor by the Carrier shall render all
...
<div>
	<p class="para">
		<strong>Contractor Remuneration:</strong> All dollar amounts referenced in this contract are Canadian
		funds
	</p>
	<ol>
		<li>
			The Contractor shall be paid 83% (percent) of the gross load revenue less any money deducted
			for Contractor expenditures as provided under the terms of this Contractor Agreement.
		</li>
		<li>
			A 7% (percent) fee will be deducted from the Contractors' gross load revenue and paid to the
			Carrier to cover administration costs.
		</li>
		<li>
			The Carrier shall pay the Contractor based on the proceeding calendar months mileage less any
...
<ol>
	<li>
		The Contractor must submit to the Carrier all original and/or true copies receipts and/or
	...
	<li>
		The Contractor and all of their agents or employees covenants and agrees to conform to all rules
	...
	<li>
		The Contractor shall be responsible for any and all claims, judgments, orders, late fees and
	...
	<li>
		All costs associated with Registering the Contractor's equipment; Vehicle Insurance; IFTA,
		Annual and/or trip permits; will be the responsibility of the Contractor and deducted from their
		percentage earned.
	</li>
	<li>
		The Carrier does not deduct tax from the Contractor. The Contractor is responsible for all
		applicable taxes including but not limited to Income Taxes, PST & GST.
	</li>
	<li>
		In the event of an accident/incident resulting in but not limited to property damages, injuries
	...
	<li>
		Contractor's failure to report an accident as soon as practicable to the Carrier may be deemed a
	...
	<li>
		The Carrier, their insurer and/or attorneys have the right to settle any claim made by any third
	...
	<li>
		The Contractor's equipment must be maintained in a mechanical condition acceptable to the
	...
	<li>
		It is the Contractor's responsibility to supply auxiliary equipment in accordance with
	...
	<li>
		The Contractor agrees to pay for required tractor decals (which include identifiers required by
	...
	<li>
		Fuel cards/accountsf supplied, ae a courtesy and remain the property of the Carrier. All fuel
	...
	<li>
		The Contractor agrees to provide the Carrier with accurate mileage traveled in each
	...
	<li>
		The Contracrnr must first obtain "Authorization" from the Carrier to take any passengers in
	...
	<li>
		The Contractor, their agents and employees are required, per regulations, to maintain a daily
	...
	<li>
		The Contractor must supply the Carrier with any other documents or data required by the Carrier
		to comply with Transport regulations
	</li>
	<li>
		The Contractor is solely responsible for the costs and control of their agent, employees and
		equipment. The Carrier assumes no liability and the Contractor shall indemnify and save the
		Carrier harmless.
	</li>
	<li>
		Contractors, their agents/employees must always have valid travel insurance and/or WCB while
	...
	<li>
		The Contractor is required to provide 30 days written notice to the Carrier of their intent to
		·.:erminate the contract and failure to do so may result in costs related to recovery of freight
		etc.if the Contractor abandons their duties.
	</li>
</ol>
<p class="para">
	<strong>Carrier Responsibilities:</strong>
</p>

<ol>
	<li>
		The Contractors' equipment shall be insured under the Carrier's fleet insurance policy(s) in
	...
	<li>
		The Carrier shall pay the cost of insurance coverage, under their insurance policy, on behalf of
		the Contractor. The Carrier will then deduct the insurance costs from the Contractor's revenue.
	</li>
	<li>
		All regulatory provincial permits, and licenses required, will be obtained by the Carrier on the
	...
	<li>
		The Contractor will pay the costs ELD instillation and monthly fees. The Carrier maintains
	...
	<li>
		If the Contractor breaches terms of this contract the Carrier may, at its discretion, terminate
		the contract.
	</li>
</ol>
